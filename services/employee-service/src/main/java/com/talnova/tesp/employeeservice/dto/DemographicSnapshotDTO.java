...
@Schema(description = "Immutable Demographic Snapshot DTO")
public class DemographicSnapshotDTO {
    ...
    public DemographicSnapshotDTO() {
    }

    public DemographicSnapshotDTO(String id, String projectId, String surveyId, String employeeId,
    ...
    public static class Builder {
        ...
        public DemographicSnapshotDTO build() {
            return new DemographicSnapshotDTO(id, projectId, surveyId, employeeId, nodeId, matrixNodeIds, demographics, capturedAt);
        }
    }
}
