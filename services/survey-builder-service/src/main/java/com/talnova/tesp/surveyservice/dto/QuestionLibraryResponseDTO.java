...
@Schema(description = "Response payload for a Question Library template entry")
public class QuestionLibraryResponseDTO {
    ...
    public QuestionLibraryResponseDTO() {
    }

    public QuestionLibraryResponseDTO(String id, String libraryId, String category, QuestionType type, String groupId,
    ...
    public static class Builder {
        ...
        public QuestionLibraryResponseDTO build() {
            return new QuestionLibraryResponseDTO(id, libraryId, category, type, groupId, prompt, tags, isDeleted, createdAt, updatedAt);
        }
    }
}
